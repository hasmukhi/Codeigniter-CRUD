...
$route['products1'] = "products/index1";
$route['products_create'] = "products1/index";
...
$route['imageUpload']="products/image_index";
$route['imageStore']="products/do_upload";

$route['sendingmail']="email/index";

$route['contact']="contactform/index";
$route['contactSend']="contactform/send";
/*  $route['productsEdit/(:any)'] = "products/edit/$1";
	$route['productsUpdate/(:any)']['put'] = "products/update/$1";
	$route['productsDelete/(:any)']['delete'] = "products/delete/$1"; 
*/